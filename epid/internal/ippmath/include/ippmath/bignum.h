...
#ifndef EPID_INTERNAL_IPPMATH_INCLUDE_IPPMATH_BIGNUM_H_
#define EPID_INTERNAL_IPPMATH_INCLUDE_IPPMATH_BIGNUM_H_
...
/*!
  @}
*/
#endif  // EPID_INTERNAL_IPPMATH_INCLUDE_IPPMATH_BIGNUM_H_
