...
TEST_F(EpidSplitMemberTest, DecompressPrivKeyFailsGivenNullParameters) {
...
TEST_F(EpidSplitMemberTest, DecompressPrivKeyFailsGivenKeysMismatch) {
...
TEST_F(EpidSplitMemberTest, DecompressPrivKeyFailsGivenInvalidGroupKey) {
...
TEST_F(EpidSplitMemberTest, DecompressPrivKeyFailsGivenInvalidCompressedKey) {
  auto const& pub_key = this->kGrpXKey;
  PrivKey priv_key = {};
