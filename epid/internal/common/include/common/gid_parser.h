...
/*! \file */
#ifndef EPID_INTERNAL_COMMON_INCLUDE_COMMON_GID_PARSER_H_
#define EPID_INTERNAL_COMMON_INCLUDE_COMMON_GID_PARSER_H_
...
#endif  // EPID_INTERNAL_COMMON_INCLUDE_COMMON_GID_PARSER_H_
