...
TEST_F(EpidTpm2Test, CommitComputeKLESha384) {
  ...
  EXPECT_EQ(kEpidNoErr,
            Tpm2Commit(tpm, f_handle, p1, this->kS2Sha384.data(),
...
TEST_F(EpidTpm2Test, CommitComputeKLESha512) {
  ...
  EXPECT_EQ(kEpidNoErr,
            Tpm2Commit(tpm, f_handle, p1, this->kS2Sha512.data(),
...
TEST_F(EpidTpm2Test, CommitComputeKLESha512256) {
  ...
  EXPECT_EQ(kEpidNoErr,
            Tpm2Commit(tpm, f_handle, p1, this->kS2Sha512256.data(),
...
TEST_F(EpidTpm2Test, CommitComputeEOnly) {
  // Testing step j excluding i of the "C.2.3 Tpm2Commit()"
  Epid20Params params;
  EcPointObj k(&params.G1), l(&params.G1), e(&params.G1);
  EcPointObj p1(&params.G1, this->kP1Str);
  FfElementObj y2(&params.fq, this->kY2Sha512Str);
  ...
  EXPECT_EQ(kEpidNoErr, Tpm2Commit(tpm, f_handle, p1, nullptr, 0, nullptr, k, l,
                                   e, &counter));
  THROW_ON_EPIDERR(Tpm2ReleaseCounter(tpm, counter, f_handle));
...
TEST_F(EpidTpm2Test, CommitComputeEOnlyWithDefaultP1) {
  // Testing step k excluding i of the "C.2.3 Tpm2Commit()"
  Epid20Params params;
  ...
  EXPECT_EQ(kEpidNoErr, Tpm2Commit(tpm, f_handle, nullptr, nullptr, 0, nullptr,
                                   nullptr, nullptr, e, &counter));
  THROW_ON_EPIDERR(Tpm2ReleaseCounter(tpm, counter, f_handle));
