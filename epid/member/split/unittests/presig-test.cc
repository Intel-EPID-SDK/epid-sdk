...
///////////////////////////////////////////////////////////////////////
// EpidAddPreSigs
TEST_F(EpidSplitMemberTest, AddPreSigsFailsGivenNullPointer) {
  Prng my_prng;
...
TEST_F(EpidSplitMemberTest, AddPreSigsFailsGivenHugeNumberOfPreSigs) {
  Prng my_prng;
  MemberCtxObj member(this->kGrpXKey, this->kGrpXMember3PrivKeySha256,
                      this->kMemberPrecomp, &Prng::Generate, &my_prng);
...
TEST_F(EpidSplitMemberTest,
       AddPreSigsAddsCorrectNumberOfPresigsGivenValidInput) {
  Prng my_prng;
  MemberCtxObj member(this->kGrpXKey, this->kGrpXMember3PrivKeySha256,
                      this->kMemberPrecomp, &Prng::Generate, &my_prng);
...
///////////////////////////////////////////////////////////////////////
// EpidGetNumPreSigs
TEST_F(EpidSplitMemberTest, GetNumPreSigsReturnsZeroGivenNullptr) {
  EXPECT_EQ((size_t)0, EpidGetNumPreSigs(nullptr));
}

TEST_F(EpidSplitMemberTest, NumPreSigsForNewlyCreatedContextIsZero) {
  Prng my_prng;
  MemberCtxObj member(this->kGrpXKey, this->kGrpXMember3PrivKeySha256,
                      this->kMemberPrecomp, &Prng::Generate, &my_prng);
...
TEST_F(EpidSplitMemberTest, GetNumPreSigsReturnsNumberOfAddedPresigs) {
  Prng my_prng;
  MemberCtxObj member(this->kGrpXKey, this->kGrpXMember3PrivKeySha256,
                      this->kMemberPrecomp, &Prng::Generate, &my_prng);
