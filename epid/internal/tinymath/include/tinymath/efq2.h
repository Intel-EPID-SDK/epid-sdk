...
#ifndef EPID_INTERNAL_TINYMATH_INCLUDE_TINYMATH_EFQ2_H_
#define EPID_INTERNAL_TINYMATH_INCLUDE_TINYMATH_EFQ2_H_
#ifdef __cplusplus
extern "C" {
#endif
...
*/
bool EFq2ToAffine(EccPointFq2* result, EccPointJacobiFq2 const* in);
...
\returns true if indeed the values are equal.
         False otherwise.
*/
bool EFq2Eq(EccPointJacobiFq2 const* left, EccPointJacobiFq2 const* right);
...
\returns true if indeed the point is on the curve.
         False otherwise.
*/
bool EFq2OnCurve(EccPointFq2 const* in);
...
\returns true if indeed the value is infinity.
         False otherwise.
*/
bool EFq2IsInf(EccPointJacobiFq2 const* in);

#ifdef __cplusplus
}
#endif
#endif  // EPID_INTERNAL_TINYMATH_INCLUDE_TINYMATH_EFQ2_H_
