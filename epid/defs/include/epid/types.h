/*############################################################################
  ...
  ############################################################################*/
#ifndef EPID_DEFS_INCLUDE_EPID_TYPES_H_
#define EPID_DEFS_INCLUDE_EPID_TYPES_H_
...
/// None Split Join request
/*!
 * None Split Join request: (F, c, s)
 */
typedef struct NoneSplitJoinRequest {
  G1ElemStr F;  ///< an element in G1
  FpElemStr c;  ///< an integer between [0, p-1]
  FpElemStr s;  ///< an integer between [0, p-1]
} NoneSplitJoinRequest;
...
#endif  // EPID_DEFS_INCLUDE_EPID_TYPES_H_
