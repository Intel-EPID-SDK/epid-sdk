...
#ifndef EPID_INTERNAL_TINYMATH_INCLUDE_TINYMATH_FQ12_H_
#define EPID_INTERNAL_TINYMATH_INCLUDE_TINYMATH_FQ12_H_
#ifdef __cplusplus
extern "C" {
#endif
...
/// Calculate the conjugate of an element of Fq12.
/*!
...
\returns true if indeed the values are equal.
         False otherwise.
*/
bool Fq12Eq(Fq12Elem const* left, Fq12Elem const* right);
...
#endif
#endif  // EPID_INTERNAL_TINYMATH_INCLUDE_TINYMATH_FQ12_H_
