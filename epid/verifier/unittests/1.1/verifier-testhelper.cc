...
#include "testhelper/testdata/1.1/grp_x/privrl.inc"
};
const std::vector<uint8_t> Epid11VerifierTest::kGrpXCorruptedPrivRl = {
#include "testhelper/testdata/1.1/grp_x/corrupted_privrl.inc"
};
const std::vector<uint8_t> Epid11VerifierTest::kGrpXPrivRlSingleEntry = {
#include "testhelper/testdata/1.1/grp_x/privrl_single_entry.inc"
};

const Epid11VerifierPrecomp Epid11VerifierTest::kVerifierPrecompStr = {
#include "1.1/testdata/verifier_precmp.inc"
};
...
#include "testhelper/testdata/1.1/grp_x/member0/sig_sha256_bsn0_msg0.inc"
};
const std::vector<uint8_t>
    Epid11VerifierTest::kSigGrpXMember0Sha256Bsn0Msg0SingleEntry = {
#include "testhelper/testdata/1.1/grp_x/member0/sig_sha256_bsn0_msg0_single_entry.inc"
};
const std::vector<uint8_t>
    Epid11VerifierTest::kSigGrpXMember0Sha256Bsn0Msg0ThreeEntry = {
#include "testhelper/testdata/1.1/grp_x/member0/sig_sha256_bsn0_msg0_three_entry.inc"
};
const std::vector<uint8_t> Epid11VerifierTest::kSigGrpXMember0Sha256Bsn0Msg1 = {
#include "testhelper/testdata/1.1/grp_x/member0/sig_sha256_bsn0_msg1.inc"
};
const std::vector<uint8_t> Epid11VerifierTest::kSigGrpXMember0Sha256Bsn1Msg0 = {
#include "testhelper/testdata/1.1/grp_x/member0/sig_sha256_bsn1_msg0.inc"
};
const std::vector<uint8_t>
    Epid11VerifierTest::kSigGrpXMember0Sha256RandbaseMsg0 = {
#include "testhelper/testdata/1.1/grp_x/member0/sig_sha256_rndbase_msg0.inc"
};
const std::vector<uint8_t>
    Epid11VerifierTest::kSigGrpXMember0Sha256RandbaseMsg0N2One = {
#include "testhelper/testdata/1.1/grp_x/sig_sha256_bsnrnd_msg0.inc"
};
const std::vector<uint8_t>
    Epid11VerifierTest::kSigGrpXMember0Sha256RandbaseMsg1 = {
#include "testhelper/testdata/1.1/grp_x/member0/sig_sha256_rndbase_msg1.inc"
};

const std::vector<uint8_t>
    Epid11VerifierTest::kSigGrp01Member0Sha256kBsn0Data_0_255 = {
#include "testhelper/testdata/1.1/grp01/member0/sig_bsn0_msg_0_255_sha256.inc"
};
const std::vector<uint8_t> Epid11VerifierTest::kSigGrpXMember1Sha256Bsn0Msg0 = {
#include "testhelper/testdata/1.1/grp_x/member1/sig_sha256_bsn0_msg0.inc"
};
const std::vector<uint8_t>
    Epid11VerifierTest::kSigGrpXRevokedPrivKey000Sha256Bsn0Msg0 = {
#include "testhelper/testdata/1.1/grp_x/privrevoked/signatures/sig_sha256_bsn0_msg0_revkey000.inc"
};
const std::vector<uint8_t>
    Epid11VerifierTest::kSigGrpXRevokedPrivKey001Sha256Bsn0Msg0 = {
#include "testhelper/testdata/1.1/grp_x/privrevoked/signatures/sig_sha256_bsn0_msg0_revkey001.inc"
};
const std::vector<uint8_t>
    Epid11VerifierTest::kSigGrpXRevokedPrivKey002Sha256Bsn0Msg0 = {
#include "testhelper/testdata/1.1/grp_x/privrevoked/signatures/sig_sha256_bsn0_msg0_revkey002.inc"
};
const std::vector<uint8_t> Epid11VerifierTest::kGrpRlRevokedGrpXSingleEntry = {
#include "testhelper/testdata/1.1/grprl_revoked_grp_x_single_entry.inc"
};
const std::vector<uint8_t> Epid11VerifierTest::kGrpRlRevokedGrpXFirstEntry = {
#include "testhelper/testdata/1.1/grprl_revoked_grp_x_first_entry.inc"
};
const std::vector<uint8_t> Epid11VerifierTest::kGrpRlRevokedGrpXMiddleEntry = {
#include "testhelper/testdata/1.1/grprl_revoked_grp_x_middle_entry.inc"
};
const std::vector<uint8_t> Epid11VerifierTest::kGrpRlRevokedGrpXLastEntry = {
#include "testhelper/testdata/1.1/grprl_revoked_grp_x_last_entry.inc"
};
const std::vector<uint8_t>
    Epid11VerifierTest::kGrpXSigRlMember0Bsn0Msg0SingleEntry = {
#include "testhelper/testdata/1.1/grp_x/sigrl_member0_sig_bsn0_msg0_revoked_single_entry.inc"
};
const std::vector<uint8_t>
    Epid11VerifierTest::kGrpXSigRlMember0Bsn0Msg0FirstEntry = {
#include "testhelper/testdata/1.1/grp_x/sigrl_member0_sig_bsn0_msg0_revoked_first_entry.inc"
};
const std::vector<uint8_t>
    Epid11VerifierTest::kGrpXSigRlMember0Bsn0Msg0MiddleEntry = {
#include "testhelper/testdata/1.1/grp_x/sigrl_member0_sig_bsn0_msg0_revoked_middle_entry.inc"
};
const std::vector<uint8_t>
    Epid11VerifierTest::kGrpXSigRlMember0Bsn0Msg0LastEntry = {
#include "testhelper/testdata/1.1/grp_x/sigrl_member0_sig_bsn0_msg0_revoked_last_entry.inc"
};
