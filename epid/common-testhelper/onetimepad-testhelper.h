...
#ifndef EPID_COMMON_TESTHELPER_ONETIMEPAD_TESTHELPER_H_
#define EPID_COMMON_TESTHELPER_ONETIMEPAD_TESTHELPER_H_
...
#endif  // EPID_COMMON_TESTHELPER_ONETIMEPAD_TESTHELPER_H_
