 ...
 * @{
 */
#ifndef EPID_INTERNAL_COMMON_INCLUDE_COMMON_EPID2PARAMS_H_
#define EPID_INTERNAL_COMMON_INCLUDE_COMMON_EPID2PARAMS_H_
...
/*! @} */
#endif  // EPID_INTERNAL_COMMON_INCLUDE_COMMON_EPID2PARAMS_H_
