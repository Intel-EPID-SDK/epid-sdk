 ...
 * @{
 */
#ifndef EPID_INTERNAL_COMMON_INCLUDE_COMMON_COMMITMENT_H_
#define EPID_INTERNAL_COMMON_INCLUDE_COMMON_COMMITMENT_H_
...
/*! @} */
#endif  // EPID_INTERNAL_COMMON_INCLUDE_COMMON_COMMITMENT_H_
