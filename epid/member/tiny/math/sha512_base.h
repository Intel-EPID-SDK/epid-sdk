...
/*!
* \file
* \brief Algorithms of sha-384, sha-512 and sha-512/256 are the same,
but differ in digest size. Functions of this file are used in those functions
*/

#ifndef EPID_MEMBER_TINY_MATH_SHA512_BASE_H_
#define EPID_MEMBER_TINY_MATH_SHA512_BASE_H_
...
#endif  // EPID_MEMBER_TINY_MATH_SHA512_BASE_H_
