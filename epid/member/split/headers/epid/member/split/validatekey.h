...
#ifndef EPID_MEMBER_SPLIT_SRC_VALIDATEKEY_H_
#define EPID_MEMBER_SPLIT_SRC_VALIDATEKEY_H_
...
/*!
  ...
  \param[in] f_handle
  Handle to f part of private key.
...
bool EpidMemberIsKeyValid(MemberCtx* ctx, G1ElemStr const* A_str,
                          FpElemStr const* x_str, Tpm2Key const* f_handle,
                          G1ElemStr const* h1_str, G2ElemStr const* w_str);

#endif  // EPID_MEMBER_SPLIT_SRC_VALIDATEKEY_H_
