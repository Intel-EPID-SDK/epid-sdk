...
#ifndef EPID_INTERNAL_IPPMATH_INCLUDE_IPPMATH_ECGROUP_H_
#define EPID_INTERNAL_IPPMATH_INCLUDE_IPPMATH_ECGROUP_H_
...
@}
*/
#endif  // EPID_INTERNAL_IPPMATH_INCLUDE_IPPMATH_ECGROUP_H_
