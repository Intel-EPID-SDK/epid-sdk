...
/*! \file */
#ifndef EPID_MEMBER_SPLIT_SRC_NRPROVE_H_
#define EPID_MEMBER_SPLIT_SRC_NRPROVE_H_
...
typedef struct SplitNrProof SplitNrProof;
/// \endcond
...
/*!
 ...
 \param[in] basename
 The basename used in EpidSplitSignBasic.
 ...
 \note
 This function should be used in conjunction with EpidSplitSignBasic().

 \note
 If the result is not ::kEpidNoErr, the content of proof is undefined.

 \see EpidMemberInit
 \see EpidSplitSignBasic
 */
...
#endif  // EPID_MEMBER_SPLIT_SRC_NRPROVE_H_
