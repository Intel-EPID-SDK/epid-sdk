...
#ifndef EPID_INTERNAL_TINYMATH_INCLUDE_TINYMATH_FQ6_H_
#define EPID_INTERNAL_TINYMATH_INCLUDE_TINYMATH_FQ6_H_
#ifdef __cplusplus
extern "C" {
#endif
...
\returns true if indeed the values are equal.
         False otherwise.
*/
bool Fq6Eq(Fq6Elem const* left, Fq6Elem const* right);

/// Test if an element is zero.
/*!
\param[in] in the element to test.
\returns true if indeed
         False otherwise.
*/
bool Fq6IsZero(Fq6Elem const* in);
...
#endif
#endif  // EPID_INTERNAL_TINYMATH_INCLUDE_TINYMATH_FQ6_H_
