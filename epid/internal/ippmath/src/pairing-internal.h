...
#ifndef EPID_INTERNAL_IPPMATH_SRC_PAIRING_INTERNAL_H_
#define EPID_INTERNAL_IPPMATH_SRC_PAIRING_INTERNAL_H_
...
#endif  // EPID_INTERNAL_IPPMATH_SRC_PAIRING_INTERNAL_H_
