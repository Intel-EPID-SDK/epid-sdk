...
TEST(TinyEFqTest, DISABLED_EFqRandSelectsMinRootRandomly) {
...
// Test disabled because the current implementation selects the root
// deterministically rather than selecting a root at random.
TEST(TinyEFqTest, DISABLED_EFqRandSelectsMaxRootRandomly) {
  OneTimePad otp({0x25, 0xeb, 0x8c, 0x48, 0xff, 0x89, 0xcb, 0x85, 0x4f, 0xc0,
                  0x90, 0x81, 0xcc, 0x47, 0xed, 0xfc, 0x86, 0x19, 0xb2, 0x14,
                  0xfe, 0x65, 0x92, 0xd4, 0x8b, 0xfc, 0xea, 0x9c, 0x9d, 0x8e,
                  0x32, 0x44, 0xd7, 0xd7, 0xe9, 0xf1, 0xf7, 0xde, 0x60, 0x56,
  ...
  EccPointFq expected = {{0xd78542d3, 0xf824c127, 0x81eea621, 0x6990833d,
                          0x9d843df6, 0x3df36126, 0x435e8eda, 0x2d267586},
                         {0x93456ec8, 0x79c168bb, 0xb0c93c25, 0x0a4bb03e,
                          0xa54a1c46, 0x1a93b4c4, 0x92f209ef, 0x51aa6f36}};
...
// Test disabled because the current implementation selects the root
// deterministically rather than selecting a root at random.
TEST(TinyEFqTest, DISABLED_EFqRandSelectsRootRandomlyWhenFirstRootFails) {
  OneTimePad otp(
      {0x01, 0x80, 0x3c, 0xd1, 0x08, 0xd8, 0x8d, 0x73, 0xaf, 0xea, 0x79, 0xc8,
       0x1e, 0x47, 0x83, 0xc6, 0x95, 0x31, 0x39, 0x03, 0xc4, 0x18, 0xf1, 0x2b,
       0x4c, 0x1a, 0x34, 0x50, 0x6d, 0x73, 0x29, 0xd2, 0x0f, 0x40, 0xc4, 0x19,
  ...
  EccPointFq expected = {{0x5f65199e, 0x59366f56, 0xb1d35d89, 0xf42fdc1f,
                          0x07fd66d6, 0x95f32cb3, 0xc4ef7101, 0xeb426988},
                         {0x2b91be1e, 0x090d0ed6, 0x35e33940, 0x4ed65ea4,
                          0x5cec3f73, 0x932c047d, 0x98dd889e, 0xdd2f36b3}};
