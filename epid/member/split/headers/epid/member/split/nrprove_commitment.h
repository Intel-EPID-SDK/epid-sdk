...
/*! \file */
#ifndef EPID_MEMBER_SPLIT_SRC_NRPROVE_COMMITMENT_H_
#define EPID_MEMBER_SPLIT_SRC_NRPROVE_COMMITMENT_H_

#include <stddef.h>
#include "epid/errors.h"
#include "epid/types.h"  // HashAlg, G1ElemStr
...
typedef struct NrProveCommitOutput {
  G1ElemStr T;   ///< T value for SplitNrProof
...
#endif  // EPID_MEMBER_SPLIT_SRC_NRPROVE_COMMITMENT_H_
