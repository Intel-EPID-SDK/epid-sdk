...
#ifndef EPID_INTERNAL_IPPMATH_INCLUDE_IPPMATH_FINITEFIELD_H_
#define EPID_INTERNAL_IPPMATH_INCLUDE_IPPMATH_FINITEFIELD_H_
...
// Clears the information stored in FfElement.
/*!
 Clears the memory pointed to by ff_elem.
...
/// Checks if given finite field element is the multiplicative identity (one).
/*!
 \param[in] ff
 The finite field.
 \param[out] a
...
#endif  // EPID_INTERNAL_IPPMATH_INCLUDE_IPPMATH_FINITEFIELD_H_
