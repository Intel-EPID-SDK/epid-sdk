...
#ifndef EPID_INTERNAL_TINYMATH_INCLUDE_TINYMATH_FQ2_H_
#define EPID_INTERNAL_TINYMATH_INCLUDE_TINYMATH_FQ2_H_
#ifdef __cplusplus
extern "C" {
#endif
...
\returns true if indeed the values are equal.
         False otherwise.
*/
bool Fq2Eq(Fq2Elem const* left, Fq2Elem const* right);
...
\returns true if indeed the value is zero.
         False otherwise.
*/
bool Fq2IsZero(Fq2Elem const* value);
...
#endif
#endif  // EPID_INTERNAL_TINYMATH_INCLUDE_TINYMATH_FQ2_H_
