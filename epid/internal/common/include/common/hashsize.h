...
#ifndef EPID_INTERNAL_COMMON_INCLUDE_COMMON_HASHSIZE_H_
#define EPID_INTERNAL_COMMON_INCLUDE_COMMON_HASHSIZE_H_
...
#endif  // EPID_INTERNAL_COMMON_INCLUDE_COMMON_HASHSIZE_H_
