/*############################################################################
  ...
  ############################################################################*/
/// Implementation of Intel(R) EPID specific predicates for gtest
/*! \file */
...
static const struct EpidStatusTextEntry kEnumToText[] = {
    ...
    EPID_STATUS_TEXT_ENTRY_VALUE(kEpidBadJoinRequestErr),
    EPID_STATUS_TEXT_ENTRY_VALUE(kEpidSchemaNotSupportedErr),
    EPID_STATUS_TEXT_ENTRY_VALUE(kEpidKeyNotInGroupErr),
    EPID_STATUS_TEXT_ENTRY_VALUE(kEpidPrecompNotInGroupErr),
    EPID_STATUS_TEXT_ENTRY_VALUE(kEpidVersionMismatchErr),
    EPID_STATUS_TEXT_ENTRY_VALUE(kEpidMaxVersionErr),
    EPID_STATUS_TEXT_ENTRY_VALUE(kEpidBitSupplierErr),
    EPID_STATUS_TEXT_ENTRY_VALUE(kEpidBadCtxErr),
    EPID_STATUS_TEXT_ENTRY_VALUE(kEpidBadGroupPubKeyErr),
    EPID_STATUS_TEXT_ENTRY_VALUE(kEpidBadSignatureErr),
    EPID_STATUS_TEXT_ENTRY_VALUE(kEpidBadNrProofErr),
    EPID_STATUS_TEXT_ENTRY_VALUE(kEpidBadPrivRlErr),
    EPID_STATUS_TEXT_ENTRY_VALUE(kEpidBadSigRlErr),
    EPID_STATUS_TEXT_ENTRY_VALUE(kEpidBadSigRlEntryErr),
    EPID_STATUS_TEXT_ENTRY_VALUE(kEpidBadGroupRlErr),
    EPID_STATUS_TEXT_ENTRY_VALUE(kEpidBadVerifierRlErr),
    EPID_STATUS_TEXT_ENTRY_VALUE(kEpidBadPrecompErr),
    EPID_STATUS_TEXT_ENTRY_VALUE(kEpidBadBasenameErr),
    EPID_STATUS_TEXT_ENTRY_VALUE(kEpidBadMessageErr),
    EPID_STATUS_TEXT_ENTRY_VALUE(kEpidBadRlEntryErr),
    EPID_STATUS_TEXT_ENTRY_VALUE(kEpidBadIPrivKeyErr),
    EPID_STATUS_TEXT_ENTRY_VALUE(kEpidBadGidErr),
    EPID_STATUS_TEXT_ENTRY_VALUE(kEpidBadPrivKeyErr),
    EPID_STATUS_TEXT_ENTRY_VALUE(kEpidBadNonceErr),
    EPID_STATUS_TEXT_ENTRY_VALUE(kEpidBadMembershipCredentialErr),
    EPID_STATUS_TEXT_ENTRY_VALUE(kEpidBadRekeySeedErr),
    EPID_STATUS_TEXT_ENTRY_VALUE(kEpidUnrelatedKeyPairErr),
    EPID_STATUS_TEXT_ENTRY_VALUE(kEpidBadConfigErr),
    EPID_STATUS_TEXT_ENTRY_VALUE(kEpidBasenameNotRegisteredErr),
    EPID_STATUS_TEXT_ENTRY_VALUE(kEpidBadArgErr)};
