 ...
 * @{
 */
#ifndef EPID_INTERNAL_COMMON_INCLUDE_COMMON_GROUPPUBKEY_H_
#define EPID_INTERNAL_COMMON_INCLUDE_COMMON_GROUPPUBKEY_H_
...
/*! @} */
#endif  // EPID_INTERNAL_COMMON_INCLUDE_COMMON_GROUPPUBKEY_H_
